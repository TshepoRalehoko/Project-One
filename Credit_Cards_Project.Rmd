...
knitr::opts_chunk$set(echo = FALSE, eval = TRUE, warning = FALSE, comment = NA, fig.height = 4.5, fig.width = 5, collapse = TRUE, results = 'hide', out.width = '55%', out.height = '55%',
...
\indent The next section will take a look at \textbf{Data Description and Data Summary}. It will use various functions to study the structure of the dataset; the variables that make up the dataset and summary statistics. The \textbf{Data Preparation} section is dedicated to addressing any issues that we might have discovered in the preceding section, and taking the corrective steps to prepare the dataset for model building and analysis.
